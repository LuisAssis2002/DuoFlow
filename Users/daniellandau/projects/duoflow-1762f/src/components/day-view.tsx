  ...
  return (
    <div className="rounded-lg border bg-card p-4 md:p-6 animate-in fade-in-50">
      <div className="flex flex-col sm:flex-row items-center justify-between mb-4 gap-4">
        ...
        <div className="hidden sm:block w-[136px]"/> {/* Spacer */}
      </div>
        <div className="mb-6 flex justify-center">
             <RadioGroup value={filter} onValueChange={(value: Filter) => setFilter(value)} className="flex items-center gap-4 md:gap-6">
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="all" id="r-all-day" />
                <Label htmlFor="r-all-day" className="cursor-pointer">Todas</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="me" id="r-me-day" />
                <Label htmlFor="r-me-day" className="cursor-pointer">Minhas</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="partner" id="r-partner-day" />
                <Label htmlFor="r-partner-day" className="cursor-pointer">Dele(a)</Label>
              </div>
          </RadioGroup>
        </div>
