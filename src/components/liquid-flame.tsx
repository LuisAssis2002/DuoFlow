      ...
      <svg width="100%" height="100%" viewBox="250 0 550 1024" preserveAspectRatio="xMidYMid meet">
        <defs>
          <clipPath id="flameClip">
            {/* O clip path agora também tem um stroke para conter o líquido */}
            <path 
        ...
        {/* Contorno da Chama */}
        <g stroke="hsl(var(--border))" strokeWidth={strokeWidth} fill="none" strokeLinecap="round" strokeLinejoin="round">
